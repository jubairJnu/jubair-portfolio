  ...
  return (
    <div className="mt-7 pb-7">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8 items-center">
        {/* skills */}
        <div className="grid md:col-span-2  bg-linear-to-r from-[#0c1222] to-[#000003] rounded-lg text-white shadow-[5px_1px_10px_1px_rgba(0,0,0,0.3)] ">
          {/* image */}
        ...
        <Projects />
        {/* blogs */}
        <div className="bg-linear-to-r from-[#0c1222] to-[#000003] rounded-lg text-white shadow-[5px_1px_10px_1px_rgba(0,0,0,0.3)] ">
