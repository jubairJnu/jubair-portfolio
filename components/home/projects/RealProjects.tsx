...
const RealProjects = () => {
  return (
    <div>
      ...
      <div className="mt-10">
        <Card className="bg-linear-to-r from-[#8a026f] to-[#333399] text-white">
      ...
      <div className="my-10">
        <Card className="bg-linear-to-r from-[#174a5e] to-[#333399] text-white">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5  items-center px-2">
            <div className="grid col-span-2">
              <CardHeader>
                <h1 className="text-3xl font-bold ">
      ...
      <div>
        <Card className="bg-linear-to-r from-[#111111] to-[#006663] text-white">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5  items-center px-2">
            <div className="grid col-span-2">
              <CardHeader>
                <h1 className="text-3xl font-bold ">
