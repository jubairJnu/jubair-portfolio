...
const DemoProjects = () => {
  return (
    <div>
      {/* 1 */}
      <div className="mt-10">
        <Card className="bg-linear-to-r from-[#667eea] to-[#764ba2] text-white">
      ...
      {/* 2 */}
      <div className="mt-10">
        <Card className="bg-linear-to-r from-[#9c0212] to-[#301847] text-white">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5  items-center px-2">
            <div className="grid col-span-2">
              <CardHeader>
                <h1 className="text-3xl font-bold ">
      ...
      {/* 3 */}
      <div className="mt-10">
        <Card className="bg-linear-to-r from-[#007991] to-[#96C93D] text-white">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5  items-center px-2">
            <div className="grid col-span-2">
              <CardHeader>
                <h1 className="text-3xl font-bold ">
